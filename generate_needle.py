...
This one says which way it points three times over - an arrowhead, a forked tail, and
a red half against a pale one - and is centred, so rotation turns it on the spot.
"""
